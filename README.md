...
[![效果预览](https://raw.githubusercontent.com/gstranded/autocast-boss-assistant/main/docs/assets/readme/hero.jpg)](https://github.com/gstranded/autocast-boss-assistant)
...
4. 开启“开发者模式”，点击“加载已解压的扩展程序”，选择解压后的 `extension` 目录。
...
[![任务页](https://raw.githubusercontent.com/gstranded/autocast-boss-assistant/main/docs/assets/readme/panel-task.jpg)](https://github.com/gstranded/autocast-boss-assistant)
...
- 扫描预览会持续把 BOSS 动态职位列表滚动到底，并按岗位标识累计去重；如果 60 秒内仍未到底，就停止滚动并使用当时累计的全部岗位开始筛选。面板实时显示累计岗位数，结果中写明滚动轮数、耗时和停止原因（v1.7.13）。
- 扫描只读取和筛选岗位，不会发起沟通。
...
[![筛选页](https://raw.githubusercontent.com/gstranded/autocast-boss-assistant/main/docs/assets/readme/panel-filter.jpg)](https://github.com/gstranded/autocast-boss-assistant)
...
[![消息页](https://raw.githubusercontent.com/gstranded/autocast-boss-assistant/main/docs/assets/readme/panel-message.jpg)](https://github.com/gstranded/autocast-boss-assistant)
...
[![简历页](https://raw.githubusercontent.com/gstranded/autocast-boss-assistant/main/docs/assets/readme/panel-resume.jpg)](https://github.com/gstranded/autocast-boss-assistant)
...
[![设置页](https://raw.githubusercontent.com/gstranded/autocast-boss-assistant/main/docs/assets/readme/panel-settings.jpg)](https://github.com/gstranded/autocast-boss-assistant)
...
[![记录页](https://raw.githubusercontent.com/gstranded/autocast-boss-assistant/main/docs/assets/readme/panel-history.jpg)](https://github.com/gstranded/autocast-boss-assistant)
